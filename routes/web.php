...
Route::get('/', [\App\Http\Controllers\User\PostController::class, 'index'])->name('home');
Route::get('/article/{slug}', [\App\Http\Controllers\User\PostController::class, 'show'])->name('posts.single');
