            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <!-- ... card-header ... -->
                        <form role="form" method="POST" action="{{ route('posts.update', ['tag' => $tag->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="title">Название</label>
                                    <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $tag->title) }}" required>
                                </div>
